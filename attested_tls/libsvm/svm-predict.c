...
int main(int argc, char **argv)
{
	...
	for(int i = 0; i < model->nr_class; i++)
	  /* printf("%f ", model->label[i]); */
	  printf("%d ", model->label[i]);
	printf("]\n");
	/* printf("probA=%f\n", model->probA); */
	/* printf("probB=%f\n", model->probB); */
	/* printf("prob_density_marks=%f\n", model->prob_density_marks); */
	/* printf("sv_indices=%d\n", model->sv_indices); */
	/* printf("label=%d\n", model->label); */
	/* printf("nSB=%d\n", model->nSV); */
	/* printf("free_SV=%d\n", model->free_sv); */
	...
	for(i=0; i<735; i++)
	  printf("Svm node[i=%d]:index=%d, value=%f\n", i, model->SV[i]->index, model->SV[i]->value);

	// Print sv_indices
	/* printf("svm_indices=["); */
	/* printf("%d", model->sv_indices[0]); */
	/* fflush(stdout); */
	/* /\* for(i = 0; i < 1; i++) *\/ */
	/*   /\* printf("%f ", model->label[i]); *\/ */
	/*   printf("%d ", model->sv_indices[i]); */
	printf("]\n");
